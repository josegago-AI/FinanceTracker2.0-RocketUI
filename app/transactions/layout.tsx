        ...
        <div className="flex flex-col flex-grow pt-5 overflow-y-auto bg-white dark:bg-gray-800 border-r shadow-elevation-1">
          ...
          <div className="mt-8 flex-grow flex flex-col">
            <nav className="flex-1 px-2 space-y-1">
              ...
              <NavItem href="/accounts" icon={Wallet}>Accounts</NavItem>
              <NavItem href="/transactions" icon={CreditCard}>Transactions</NavItem>
              <NavItem href="/categories" icon={FolderOpen}>Categories</NavItem>
