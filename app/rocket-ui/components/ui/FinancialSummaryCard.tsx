...
export default function FinancialSummaryCard({ title, amount, change, changeType, icon, iconColor }: Props) {
  ...
  return (
    <div className="bg-card rounded-xl p-5 shadow-elevation-1">
      ...
      <div className="text-2xl font-semibold">{new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(amount)}</div>
      {change !== 0 && (
